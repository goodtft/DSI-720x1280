...
5.You can clear the files generated by the compiler driver.
  ### sudo ./DSI-720x1280-show clean

6.You can uninstall the currently installed drivers from the system.
  ### sudo ./DSI-720x1280-show uninstall
